...
export interface ValidationChange { readonly status: string; readonly score?: number; readonly oldPath?: string; readonly path: string }
export interface ValidationImpact {
  readonly schema: "a1-validation-impact-v2";
  ...
  readonly prCore: ValidationOwnershipSelection;
  readonly integration: { readonly selection: IntegrationSelection; readonly fallback: string | null };
  readonly rendering: { readonly tier: RenderingImpactTier; readonly reasons: readonly string[]; readonly fallbacks: readonly string[]; readonly changedPaths: readonly string[] };
...
export function selectValidationImpact(options?: { readonly repository?: string; readonly base?: string; readonly head?: string; readonly includeWorktree?: boolean; readonly manualNoComparison?: boolean; readonly implementationBound?: boolean }): Promise<ValidationImpact>;
