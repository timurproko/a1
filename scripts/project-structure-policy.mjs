...
export const PROJECT_OWNERS = Object.freeze({
  ...
  composition: owner("composition", "entry", "src/composition", "test/composition", ["agent-engine-contracts", "presentation-contracts", "owned-ui-contracts", "pi-engine-adapter", "pi-tui-runtime-adapter"]),
