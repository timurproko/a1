...
export const TERMINAL_PARITY_ACTIONS = Object.freeze([
  ...
  { type: "key", key: "enter" },
  { type: "checkpoint", name: "settings-theme-single", domains: ["selector-dialog", "settings", "nested-dialog", "raw-ansi", "cursor-focus"] },
  { type: "key", key: "up" },
  { type: "key", key: "enter" },
  { type: "checkpoint", name: "settings-theme-automatic", domains: ["selector-dialog", "settings", "nested-dialog", "raw-ansi", "cursor-focus"] },
  { type: "key", key: "enter" },
  { type: "checkpoint", name: "settings-theme-light", domains: ["selector-dialog", "settings", "nested-dialog", "raw-ansi", "cursor-focus"] },
  { type: "key", key: "escape" },
  { type: "key", key: "escape" },
  { type: "key", key: "escape" },
  { type: "checkpoint", name: "settings-theme-cancel-restored", domains: ["selector-dialog", "settings", "editor", "footer-status", "cursor-focus"] },
  ...
  { type: "key", key: "enter" },
  { type: "checkpoint", name: "login-provider-status", domains: ["selector-dialog", "authentication", "models", "footer-status", "cursor-focus"] },
  { type: "key", key: "escape" },
  { type: "key", key: "escape" },
