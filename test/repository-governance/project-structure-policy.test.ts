...
describe("project structure ownership policy", () => {
  it("declares every production and test owner with one public entry", () => {
    expect(Object.keys(PROJECT_OWNERS)).toEqual([
      "cli", "launch", "workspace", "lifecycle", "protocol", "release", "storage", "structured-agent-runtime", "native-host-protocol", "supervision", "workspace-contracts", "transparent-terminal",
    ]);
