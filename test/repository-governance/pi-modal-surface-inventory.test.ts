...
const inventoryPath = "config/baselines/modal-surface-inventory.json";
...
function validateGraph(inventory: Inventory, sources: Record<string, string>): void {
  ...
  if (inventory.pinned.version !== pinned.version || inventory.pinned.commit !== pinned.commit) throw new Error("stale pinned identity");
