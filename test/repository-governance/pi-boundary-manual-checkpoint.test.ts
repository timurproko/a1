...
describe("Pi-boundary manual candidate checkpoint", () => {
  it("provides user-controlled commands without claiming workstation automation", async () => {
    ...
    for (const value of [
      "Bare owned UI", "Extension surfaces", "Vanilla oracle", "Isolated profile", "Resize and input", "Shutdown", "Recovery",
      "& $Candidate pi", "& $Candidate sandbox", "READY, MANUAL EXECUTION PENDING",
