...
import { CURSOR_MARKER, stripTerminalSequences, visibleWidth, type AutocompleteProvider } from "@earendil-works/pi-tui";
...
describe.each([false, true])("above-prompt autocomplete (history=%s)", history => {
  ...
  it("matches the live prompt border color and width without copying border labels", async () => {
