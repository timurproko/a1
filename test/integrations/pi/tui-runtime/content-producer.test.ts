...
import { runRenderingProducer, type RenderingProducerResult } from "../../../support/rendering/rendering-producer.js";
import { classifyTerminalPaint, replayTerminalCheckpoints, replayTerminalPaint } from "../../../support/rendering/terminal-paint-evidence.js";
...
describe("source-faithful scheduled content producers", () => {
  it.each(CONTENT_RENDERING_WORKLOADS)("preserves intermediate and final content at $columns x $rows", async workload => {
