...
8. Create no acceptance, spec-only, or archive-only follow-up PR. Verify the integrated archive, synchronized specs, acceptance provenance, and exact-head remote branch cleanup before local cleanup.
