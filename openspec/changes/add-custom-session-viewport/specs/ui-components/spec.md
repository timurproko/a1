...
The shared scrollbar SHALL accept a speed of `normal`, `fast`, or `high`. Normal SHALL map one wheel event to three lines, fast to six lines, and high to twelve lines. Appearance and style SHALL NOT change that selected wheel distance.
