...
- [x] 2.2 Re-pin `config/startup-graph-baseline.json` to 152 files and 1,427,745 bytes; run `npm run typecheck`, `check:architecture`, `check:code-documentation`, the changed-documentation check, and the session-shell, composition, TUI runtime, and owned-UI feature suites; record outcomes: all checks OK, 1,087 passed.
