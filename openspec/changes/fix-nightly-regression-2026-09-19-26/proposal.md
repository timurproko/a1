...
The Full regression run of 2026-09-19-26 failed on `develop` at `e12ed66` (https://github.com/timurproko/a1/actions/runs/35435187565). Failed: `vitest-fast-resource-sensitive` (fast-resource-sensitive) on ubuntu-24.04-node24. The nightly triage opened this change so the fix starts from the recorded evidence instead of the failure email.
