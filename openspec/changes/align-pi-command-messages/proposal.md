...
- Correct interactive command notifications across success, warning, failure, empty, and cancellation states, including authentication, import, share links, fork/clone empty states, and new-session spacing.
- Preserve pinned message wrapping, padding, severity, placement, and consecutive-status behavior through owned presenters rather than raw formatted rows.
