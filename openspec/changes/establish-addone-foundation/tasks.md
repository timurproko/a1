...
- [ ] 1.94 Preserve Native Pi's final normal-screen cursor and child-produced line breaks exactly, remove AddOne's synthetic restoration newline, and permanently compare direct and hosted closure layout so `To resume this session:` retains one native blank row before and after it without content-specific production adjustment.
