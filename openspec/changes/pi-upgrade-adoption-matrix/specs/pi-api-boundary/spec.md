...
- **WHEN** the newest published version is listed in the skip list or the freeze date has not passed
- **THEN** the sync SHALL propose the newest unskipped version newer than the pin, or none, and SHALL name the skip or freeze in its output
