...
- **THEN** A1 SHALL report bounded durations for bootstrap, guardian, UI module loading, Pi services, resource loading, session creation, and first render without exposing credentials or prompt/session content
