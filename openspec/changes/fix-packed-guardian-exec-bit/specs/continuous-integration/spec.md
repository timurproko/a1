...
#### Scenario: Posix materialization spawns the packed helper
- **WHEN** the exact package is installed and materialized on linux or darwin
- **THEN** the native process guardian SHALL be executable and the packaged public launch chain SHALL spawn it successfully
