...
- [x] 2.1 Add renderer coverage for ruled compact geometry, bottom anchoring, bounded width, title/path/options/hint styling, selected-row changes, and narrow or short terminals.
...
- [x] 3.2 Build and prepare a color-preserving manual launch handoff from two unrelated folders and one covered descendant, verifying per-path decisions, bottom-dialog appearance, cancellation, and parent-terminal restoration.
