...
- [ ] 7.3 Rebuild `PiSessionShell` startup composition and persistent visual tree from public Pi components plus provenance-recorded controller ports, including vanilla header/notices, transcript spacing, stateful editor, command autocomplete, keybinding hints, status indicators, and footer; pass separate pinned-upstream versus AddOne captures at fixed widths and startup states.
