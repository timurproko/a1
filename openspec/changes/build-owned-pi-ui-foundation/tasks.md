...
- [x] 7.5 Port user, assistant, thinking, system, custom, bash, tool-call, tool-result, retry, compaction, and error presentation as stateful pinned components; pass lifecycle, streaming, replacement, wrapping, Unicode, and resize comparisons.
