...
The supplied comparison screenshots display Pi `0.84.2` and are diagnostic rather than acceptance evidence. Source tracing confirms the relevant changelog, `showError()`, `/export`, `showStatus()`, and `/reload` behavior in pinned Pi `0.84.1`; implementation and independent parity remain pinned to `0.84.1` and commit `53fa77ccd8a279eb87e92294ef3687b03ff80112`.
