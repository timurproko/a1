...
6. Run exact-head normal CI, a representative ordinary-path observation, conservative Development validation, and Full regression. Document actual latency, runner cost, selected owners, and any known gap without inventing speedup evidence.
