...
- **WHEN** a changed path under a shared-support rule is reached by no retained test, is imported from outside the test tree, or the import graph cannot be built
