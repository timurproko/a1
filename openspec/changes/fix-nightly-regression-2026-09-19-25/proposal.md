...
The Full regression run of 2026-09-19-25 failed on `develop` at `b779478` (https://github.com/timurproko/a1/actions/runs/35433536822). Failed: `vitest-full-without-isolated` (architecture, dependency-policy, dist-integration, documentation-full, fast-remainder, fast-resource-sensitive, history-compatibility, image-compatibility, launch-integration, naming-full, package-contracts, package-smoke, package-startup, pi-engine-conformance, release-update, rendering-stability, typecheck, unix-containment, update-performance, update-predecessor) on windows-2025-node22; `vitest-package-startup` (package-startup) on windows-2025-node24. The nightly triage opened this change so the fix starts from the recorded evidence instead of the failure email.
