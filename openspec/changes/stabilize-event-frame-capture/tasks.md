...
- [ ] 1.2 Use preserved pre-#374 divergence evidence to identify and reproduce the responsible callback and stage-boundary ordering with bounded controls; verify the vulnerable behavior fails independently of selection and distinguish this historical reproduction from current-baseline gap regressions.
...
- [ ] 4.1 Record verified implementation acceptance and merge evidence for archive preparation.
- [ ] 4.2 Stage and verify delta synchronization and the archive move in an OpenSpec-only candidate.
