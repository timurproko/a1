...
- [ ] 2.1 Run the focused compatibility and existing metadata-policy tests, typecheck, changed-file documentation checks, and strict OpenSpec validation; verify they pass without modifying production code, workflows, dependencies, or canonical specs.
