...
- The accepted interaction and presentation changes keep startup reachability at 157 files / 1,517,059 source bytes.
...
- `node scripts/pi/update-startup-graph-baseline.mjs --check` — passed at 157 files / 1,517,059 bytes.
