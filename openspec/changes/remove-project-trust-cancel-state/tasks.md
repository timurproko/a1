...
- [x] 2.2 Restore the terminal and propagate Escape or Ctrl+C as an expected startup interruption through the bounded process terminator with conventional exit code 130.
