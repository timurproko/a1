...
- [x] 2.2 Reset terminal input/presentation modes, restore the parent-screen cursor, finish the restored command row, and propagate Escape as a successful bounded exit while retaining status 130 for Ctrl+C.
