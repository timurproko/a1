...
- Affected governance: architecture checks, compatibility/conformance suites, package/version authority, source-port provenance tooling, parity fixtures, and release gates.
