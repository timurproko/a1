...
- [ ] 1.2 Record the original macOS job, failing truecolor/256-color cases, and 80-column row difference alongside the owned-versus-pinned key-label implementation comparison; verify the evidence identifies the omitted formatting rather than attributing the failure to color depth or Node version.
