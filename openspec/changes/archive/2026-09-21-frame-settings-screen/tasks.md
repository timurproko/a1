...
- [x] 2.2 Allocate list and footer geometry after fixed chrome, centralize list-to-screen row conversion, and verify scrolling, sticky headers, rail presentation, menus, search, notices, and structured dialogs remain inside the exact frame.
