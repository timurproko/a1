# Acceptance — move-prompt-history-to-home-data
...
- [PR #311](https://github.com/timurproko/a1/pull/311): confirmed `MERGED` at 2026-09-12T08:30:27Z; head `6f1f892fa76d907fcb499adc9dc0155bae168fdf`; merge `e5bf575f082873964e6e7bff198e10d90c7bd00f`.
  - [Successful required Development validation](https://github.com/timurproko/a1/actions/runs/34682957511/job/103526048035). This is not proof that separate Full regression, release, or physical gates passed.

## Known gaps retained

`tasks.md` is preserved byte-for-byte with **2 unchecked tasks** (3.2, 3.3). Their complete original descriptions, existing evidence, and any historical pending or contradictory findings remain authoritative evidence gaps. No checkbox was automatically completed, including mixed legacy acceptance/archive tasks or the optional mechanical tasks.
...
Synchronized implemented requirements into: `persistent-prompt-history`. Shared requirements preserve unrelated scenarios and later merged behavior.
