# Acceptance — fix-ghost-link-underlines
...
- [PR #241](https://github.com/timurproko/a1/pull/241): confirmed `MERGED` at 2026-09-05T17:17:08Z; head `4fd5da32985be21e4011be3aab8c958aaa0f3983`; merge `66cc8e6e6752bc686a11f194123c7b13f68bfdc6`.
  - [Successful required Development validation](https://github.com/timurproko/a1/actions/runs/33979993507/job/101344235187). This is not proof that separate Full regression, release, or physical gates passed.

## Known gaps retained

`tasks.md` is preserved byte-for-byte with **4 unchecked tasks** (1.2, 4.5, 5.2, 5.3). Their complete original descriptions, existing evidence, and any historical pending or contradictory findings remain authoritative evidence gaps. No checkbox was automatically completed, including mixed legacy acceptance/archive tasks or the optional mechanical tasks.
