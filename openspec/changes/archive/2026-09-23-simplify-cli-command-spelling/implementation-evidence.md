...
- Made complete help, focused direct-command help, diagnostics, and README examples direct-first.
...
- Built `a1 help`, `a1 update --help`, and `a1 install --help` output was inspected and advertised only the supported direct grammar plus the separated compatibility aliases.
