...
- Make complete help and README examples advertise only the direct forms, while focused syntax guidance remains contextual and unsupported project-local operations or independent Pi updates stay hidden.
...
- `a1-shell`: Accept and exclusively advertise word-based help/version commands and direct package-management grammar while preserving unadvertised compatibility aliases and quiet unsupported commands.
