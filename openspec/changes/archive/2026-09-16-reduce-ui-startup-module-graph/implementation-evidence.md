...
| --- | --- | ---: |
| `a1` | post-update | 1,025 ms |
| `a1` | no live supervisor | 1,147 ms |
| `a1` | warm | 1,026 ms |
| `pi` | post-update | 926 ms |
| `pi` | no live supervisor | 1,033 ms |
| `pi` | warm | 923 ms |
...
- The generated public-Pi artifact digest is `bb67e0c4d0448ee596fc34a13c834416ec865c79a3d47c9d949d56e44be2ad57`; syntax and whitespace minification reduce the emitted artifact to 8,287,198 bytes while retaining names and legal notices.
- Its reviewed baseline is 1,744 loaded files and 8,283,311 evaluated bytes. The generated manifest records normalized grouped inputs and 54 dependency license identities with no undeclared licenses.
...
- Interactive launch and warmup both call the generated descriptor's one literal eager-graph loader. Descriptor identity `fb00d3c36b3bcb0aa2f5402fa06ac758cac7585961cc483118f430e617632a48` binds the ordered eager entries, generated artifact digest, dependency-layer launch-context source, and compile-cache namespace strategy. Repeated generation is byte-stable, while entry or artifact changes alter identity; immutable release certification rejects descriptor mutation.
