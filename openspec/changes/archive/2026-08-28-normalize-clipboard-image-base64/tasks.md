...
- [x] 2.3 Ensure prompt chips retain only canonical image attachments and that prompt, steer, and follow-up command paths cannot recover the pre-normalized clipboard string; verify command-capture tests assert canonical data for each applicable submission mode
