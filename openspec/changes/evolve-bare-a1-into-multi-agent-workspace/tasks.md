...
- [x] 4.1 Record the exact Winghostty and Ghostty revisions selected for the Windows proof, their MIT licensing/notices, retained versus adapted components, patch policy, build prerequisites, and reproducible artifact manifest; pass license, provenance, and clean-build checks.
