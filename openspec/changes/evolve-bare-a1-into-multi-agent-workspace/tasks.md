...
- [x] 1.1 Record exact baseline package/tag/profile evidence and pass build, architecture, release, and strict OpenSpec gates without desktop automation; preserve the historical milestone-branch evidence without requiring future task branches.
