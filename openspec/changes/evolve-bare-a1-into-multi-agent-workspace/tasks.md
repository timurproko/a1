...
- [ ] 8.3 Enable accepted composed-pane capabilities inside the already shipped bare AddOne workspace only after composed-host recovery gates pass; keep structured-only startup, maintenance commands, unknown-command behavior, both aliases, and explicit modes unchanged and pass bootstrap, cohort, update, capability-disable, and rollback gates.
