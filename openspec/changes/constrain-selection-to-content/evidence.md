...
- The startup graph baseline is repinned from 1512675 to 1513310 source bytes for the reviewed control, pacing, and trigger code.
...
- `npx vitest run test/app/session-shell/session-viewport-controller.test.ts` — 66 tests passed, including final-row selection without auto-scroll and one-row edge ticks.
